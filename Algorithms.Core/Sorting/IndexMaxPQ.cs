...
namespace Algorithms.Core.Sorting
{
    ...
    public class IndexMaxPQ<T> : IEnumerable<int> where T : class, IComparable<T>
    {
        ...
        public IndexMaxPQ(int maxN)
        {
            ...
            _maxN = maxN;
            _keys = new T[maxN + 1];    // make this of length maxN??
            _pq = new int[maxN + 1];
        ...
        {
            return new HeapIndexMaxPQEnumerator<T>(_n, _pq, _keys);
        }
