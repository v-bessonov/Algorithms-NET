...
{
    [ConsoleCommand("AcyclicSP", "Class represents a data type for solving the single-source shortest paths problem in edge-weighted directed acyclic graphs (DAGs). The edge weights can be positive, negative, or zero.")]
    public class AcyclicSPWorker : IWorker
    {
        public void Run()
        {
