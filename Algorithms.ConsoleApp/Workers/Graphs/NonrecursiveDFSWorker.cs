...
{
    [ConsoleCommand("NonrecursiveDFS", "Class represents a data type for determining the vertices connected to a given source vertex <em>s</em> in an undirected graph.")]
    public class NonrecursiveDFSWorker : IWorker
    {
        public void Run()
        {
