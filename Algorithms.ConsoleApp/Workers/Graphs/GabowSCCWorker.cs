...
{
    [ConsoleCommand("GabowSCC", "Class represents a data type for determining the strong components in a digraph using Gabow's algorithm (aka Cheriyan-Mehlhorn algorithm).")]
    public class GabowSCCWorker : IWorker
    {
        public void Run()
        {
