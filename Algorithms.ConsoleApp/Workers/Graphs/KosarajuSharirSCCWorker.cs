...
{
    [ConsoleCommand("KosarajuSharirSCC", "Class represents a data type for determining the strong components in a digraph.")]
    public class KosarajuSharirSCCWorker : IWorker
    {
        public void Run()
        {
