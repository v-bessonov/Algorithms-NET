...
{
    [ConsoleCommand("Shell", "Provides static methods for sorting a list of IComparable using using Shellsort with Knuth's increment sequence (1, 4, 13, 40, ...)")]
    public class ShellWorker : IWorker
    {
        public void Run()
        {
