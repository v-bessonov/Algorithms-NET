...
{
    [ConsoleCommand("Quick", "Provides static methods for sorting a list of IComparable using quick sort")]
    public class QuickWorker : IWorker
    {
        public void Run()
        {
