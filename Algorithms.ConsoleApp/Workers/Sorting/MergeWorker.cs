...
{
    [ConsoleCommand("Merge", "Provides static methods for sorting a list of IComparable using merge sort")]
    public class MergeWorker : IWorker
    {
        public void Run()
        {
